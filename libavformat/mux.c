...
int avformat_write_header(AVFormatContext *s, AVDictionary **options)
{
	...
	__android_log_print(ANDROID_LOG_WARN, "mux.c", "avformat_write_header 0 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
	
    if (ret = init_muxer(s, options))
        return ret;

	__android_log_print(ANDROID_LOG_WARN, "mux.c", "avformat_write_header 1 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
	...
	__android_log_print(ANDROID_LOG_WARN, "mux.c", "avformat_write_header 2 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);


    if ((ret = init_pts(s)) < 0)
        return ret;

	__android_log_print(ANDROID_LOG_WARN, "mux.c", "avformat_write_header 3 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
