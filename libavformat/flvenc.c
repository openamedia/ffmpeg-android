...
static int flv_write_header(AVFormatContext *s)
{
	...
	__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 0 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
    ...
    for (i = 0; i < s->nb_streams; i++) {
        ...
        case AVMEDIA_TYPE_VIDEO:
			__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 0.1 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
			...
			__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 0.2 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
			...
			__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 0.3 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
		...
		__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 0.3.1 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
		
        avpriv_set_pts_info(s->streams[i], 32, 1, 1000); /* 32 bit pts in ms */

		__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 0.3.2 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);

        sc = av_mallocz(sizeof(FLVStreamContext));
        if (!sc)
            return AVERROR(ENOMEM);

		__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 0.3.3 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);

        s->streams[i]->priv_data = sc;
        sc->last_ts = -1;
		__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 0.4 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);

    }

	__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 1 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
	...
	__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 2 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
	...
	__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 3 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
	...
	__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 4 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
	...
	__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 5 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
	...
	__android_log_print(ANDROID_LOG_WARN, "flvenc.c", "flv_write_header 6 codectimebase:%d/%d, sttimebase:%d/%d", s->streams[0]->codec->time_base.num, s->streams[0]->codec->time_base.den, s->streams[0]->time_base.num, s->streams[0]->time_base.den);
